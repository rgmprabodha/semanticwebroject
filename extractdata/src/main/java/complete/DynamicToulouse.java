...
public class DynamicToulouse {
	...
	private static void processStationDyna(JSONArray stations) {
		...
		for (Object station : stations) {
			...
			String nupdatetime = String.valueOf((Double) stationJson.get("last_reported"));
		...
		System.out.println("DONE: Added Toulouse dynamic data");
	}
